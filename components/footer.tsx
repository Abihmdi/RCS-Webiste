  ...
  return (
    <footer className="relative pt-20 border-t border-border/80 overflow-hidden bg-background">
      ...
      <div className="container relative mx-auto px-4 max-w-5xl">
        <div className="grid grid-cols-2 lg:grid-cols-4 gap-x-8 gap-y-10 mb-16 items-start">
          {/* Brand */}
        ...
        <div className="min-h-12 py-3 sm:py-0 border-t border-border/70 bg-[#0a0a0a]/60 flex flex-col sm:flex-row items-center justify-between gap-3 px-4 text-[10px] font-mono text-muted-foreground -mx-4 sm:-mx-0 rounded-t-xl relative z-10">
